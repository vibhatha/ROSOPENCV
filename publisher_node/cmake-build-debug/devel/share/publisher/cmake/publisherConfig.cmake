...
if("TRUE" STREQUAL "TRUE")
  set(publisher_SOURCE_PREFIX /home/vibhatha/catkin_ws/src/publisher_node)
  set(publisher_DEVEL_PREFIX /home/vibhatha/catkin_ws/src/publisher_node/cmake-build-debug/devel)
  ...
  set(publisher_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'vibhatha <vibhatha@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vibhatha/catkin_ws/src/publisher_node/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vibhatha/catkin_ws/src/publisher_node/cmake-build-debug/devel/lib;/home/vibhatha/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
